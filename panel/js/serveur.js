...
async function sendTicketPanel() {
    ...
    try {
        const response = await fetch(`/api/guilds/${currentGuildId}/tickets/panel`, {
            method: 'POST'
        });
...
async function loadTicketStats() {
    try {
        const response = await fetch(`/api/guilds/${currentGuildId}/tickets`);
...
async function updateWarnReason(userId, warnId, newReason) {
    ...
    try {
        const response = await fetch(`/api/guilds/${currentGuildId}/warns/${userId}/${warnId}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function clearUserWarns(userId) {
    ...
    try {
        const response = await fetch(`/api/guilds/${currentGuildId}/warns?user_id=${userId}`, {
            method: 'DELETE'
        });
